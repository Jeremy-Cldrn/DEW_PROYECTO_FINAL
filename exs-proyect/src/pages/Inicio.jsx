    ...
    return (
        <Fragment>
            <section className="hero">
                ...
                <p>
                    Empieza a realizar decoraciones y arreglos a tu gusto y con detalles unicos!
                </p>
            </section>
            ...
            <section className="Nosotros" id="nosotros">
                <div className="contenedor">
                    <article className="articulo">
                        <h2>Nosotros Somos <span className='personalizado'>Detalles Unicos</span></h2>
                        <p className='descripcion'>
                            El proyecto web “Detalles Únicos” es un sitio web que muestra los diferentes opciones de regalos cada uno con un detalle diferentes, únicos es decir personalizado.
                            A través de este proyecto, las personas podrán escoger, personalizar y crear un detalle para las personas o persona a quien se la quieran dirigir  y asi expresar su cariño, amor, admiración.
            ...
            <section className="galeria">
                <h2>Nuestra <span className="personalizado">Galeria</span></h2>
